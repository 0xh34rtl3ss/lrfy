          ...
          .then(async function () {
            ...
            spotifyApi.getMyTopTracks({
              ...
              .then(async function (data) {
                  ...
                  } while (currentindex < 50 && dummysongs<10);
